\documentclass[doctor,euler,twoside,openright]{ustcthesis}
% 默认twoside 双面打印
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % 中文封面内容
  \title{LHC上W对及Higgs对伴随喷注产生的研究}
  \spinetitle{\small{LHC上W对及Higgs对伴随喷注产生的研究}}
  ...
  \covertitle{LHC上W对及Higgs对伴随喷注产生的研究}
  %\covertitle{中文题目第一行\\中文题目第二行}
  %不要在此调整封皮字体大小！ Do not set Cover Page font size here!
  %特殊情况4：本例中\title中含有多个换行，导致标题超过了两行。根据制本厂规定，封皮标题不能超过两行。因此需要定义封皮使用的标题\covertitle. 如果你注释掉这一行，就会发现封皮不符合规定。
  \encovertitle{Study of W-pair and Higgs-pair productions associated with jet at LHC}
  %\encovertitle{English Title Line 1\\English Title Line 2\\English Title Line 3}
  %不要在此调整封皮字体大小！ Do not set Cover Page font size here!
  %特殊情况5:仅本科生有用。本科封皮中有英文标题，不超过三行。与上类似。

  \author{李~~~伟~~~华}
  \depart{四系}%系别，硕博请用系代号，本科请用全称如
  %\depart{数理化和信息工程系}
  \major{粒子物理与原子核物理}%专业，硕博请用全称，本科不需要
  \advisor{马文淦\ 教授}
  \coadvisor{张仁友\ 副教授}%第二导师，没有请注释掉
%  \studentid{PB00000000}%For bachelor only
  \submitdate{二〇一五年十月}

  % 英文封面内容
  \entitle{Study of W-pair and Higgs-pair productions associated with jet at LHC}
  \enauthor{Li Wei-Hua}
  \enmajor{Particle Physics and Nuclear Physics}
  \enadvisor{Prof. Ma Wen-Gan}
  \encoadvisor{Asso.~Prof. Zhang Ren-You}%另外一个导师
  \ensubmitdate{October, 2015}
...
\mainmatter
  ...
  \include{chapter/chap-foreword}
  \include{chapter/chap-theory}
  \include{chapter/chap-wwjet}
  \include{chapter/chap-hhjets}
